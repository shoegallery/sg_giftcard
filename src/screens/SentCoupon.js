...
const SentCoupon = ({ navigation }) => {
    ...
    ><Box height={"100%"} justifyContent={"center"}><Text fontWeight={"semibold"} paddingTop={5} textAlign={"center"}>
    Уучлаарай байгууллагын санхүүгийн програмтай холбогдоогүй учраас масс coupon илгээх боломжгүй байна
  </Text></Box>
    </SafeAreaView>
    );
};

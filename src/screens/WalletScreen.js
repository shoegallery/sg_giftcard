...
const WalletScreen = ({ navigation, props }) => {
  ...
  const [receiverOrderSecond, setReceiverOrderSecond] = useState({
    value: "",
    error: "",
  });
  const [receiverPhoneSecond, setReceiverPhoneSecond] = useState({
    value: "",
    error: "",
  });
  ...
  const [receiverOrderOperator, setReceiverOrderOperator] = useState({
    value: "",
    error: "",
  });
  const [receiverPhoneOperator, setReceiverPhoneOperator] = useState({
    value: "",
    error: "",
  });
  ...
  const chargeOperator = () => {
    ...
    if (receiverAmountError || receiverPhoneError) {
      setReceiverAmountOperator({
        ...receiverAmountOperator,
        error: receiverAmountError,
      });
      setReceiverPhoneOperator({
        ...receiverPhoneOperator,
  ...
  return (
    ...
    >
      ...
      <ScrollView>
        ...
        >
          {userData.wallets.isPanel !== "officeWorker" ? (
            <Box paddingTop={"3"}>
                  ...
                  >
                    {({ isHovered, isPressed }) => {
                      return (
                        ...
                        >
                          <VStack flexDir={"row"}>
                            <Box flex={3} backgroundColor={"amber.400"}>
                              <Box>
                                {userData.wallets.phone !== undefined ? (
                                  <QRCode
        ...
        */
                  ...
                  <Center>
                    ...
                    >
                      <Modal.Content width={"80%"} maxH="412">
                        ...
                        <Modal.Body>
                          Та доорх дансаар төлбөрөө төлж, Point Plus аппын
                          дансаа цэнэглээрэй.
                          <Box width={"100%"}>
                            <HStack>
          ...
          {userData.wallets.useRole === "admin" ? (
            <Box>
              <Pressable
                paddingTop={3}
                alignItems={"center"}
                                    ...
                                    <Modal.Body>
                                      <FormControl>
                                        ...
                                        <View>
                                          <Box>
                                            <Input
                                              value={
                                                receiverPhoneOperator.value
                                              }
                                              fontSize={20}
                                              returnKeyType="next"
                                              onChangeText={(
                                                receiverAmountPhoneo
                                              ) =>
                                                setReceiverPhoneOperator({
                                      ...
                                      <Box>
                                        <Input
                                          fontSize={20}
                                          value={String(
                                            receiverAmountOperator.value
                                          )}
                                          returnKeyType="next"
                                          onChangeText={(
                                            receiverAmountNumberso
                                          ) =>
                                            setReceiverAmountOperator({
                    ...
                    >
                      <HStack>
                        <Box width={"94%"}>
                          <HStack space={2} alignSelf={"flex-start"}>
                            <Box alignSelf="center">
                              <AntDesign name="sync" size={32} color="black" />
                            </Box>
                            <Text
                              color="coolGray.800"
                              fontWeight="medium"
          ...
          {userData.wallets.useRole === "operator" ? (
            <Box>
              <Pressable
                paddingTop={3}
                paddingBottom={6}
                                    ...
                                    <Modal.Body>
                                      ...
                                      <Box>
                                        <Input
                                          fontSize={16}
                                          value={String(
                                            receiverAmountSecond.value
                                          )}
                                          returnKeyType="next"
                                          onChangeText={(
                                            receiverAmountNumbers
                                          ) =>
                                            setReceiverAmountSecond({
                                      ...
                                      <Box>
                                        <Input
                                          fontSize={16}
                                          value={String(
                                            receiverOrderSecond.value
                                          )}
                                          returnKeyType="done"
                                          onChangeText={(
                                            receiverSummeryNumbers
                                          ) =>
          ...
          <Box>
            {userData.wallets.useRole === "saler" ? (
              <Pressable
                paddingTop={3}
                paddingBottom={6}
                alignItems={"center"}
